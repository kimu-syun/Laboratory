...
def preference_distribution_Update(preference_distribution, hidden_state, sensory):
    ...
    if sensory == 0:
        ...
        preference_distribution = np.array([1/5, 1/5, 1/5, 1/5, 1/5])
    return preference_distribution
...
def child_inference(child, epoch):
    ...
    child.belief_sensory_distribution = belief_sensory_distribution_make(child.likelihood_distribution, child.belief_hiddenstate_distribution, child.belief_sensory_distribution, epoch) #q(y|a)
